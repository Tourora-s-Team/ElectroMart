...
class ImageHelper
{
     ...
     * @return string URL web đúng (vd: /electromart/public/images/electro_mart/iphone15.jpg)
     */
     ...
     * @return string
     */
    public static function getImageUrlWithFallback($imagePath, $fallback = '/electromart/public/images/no-image.jpg')
    {
