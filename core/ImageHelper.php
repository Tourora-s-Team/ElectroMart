...
class ImageHelper
{
     ...
     * @return string URL web đúng (vd: https://electromart.online/public/images/electro_mart/iphone15.jpg)
     */
    public static function getImageUrl($imagePath)
    {
        ...
        // Thêm prefix cho web
        $webUrl = 'https://electromart.online/' . $cleanPath;
     ...
     * @return string
     */
    public static function getImageUrlWithFallback($imagePath, $fallback = 'https://electromart.online/public/images/no-image.jpg')
    {
