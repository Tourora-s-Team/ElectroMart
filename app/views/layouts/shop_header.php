            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li
                        ...
                        <a href="/electromart/public/shop/products" class="nav-link">
                            <i class="fas fa-box"></i>
                            <span>Quản lý sản phẩm</span>
                        </a>
                    </li>
                    <li class="nav-item <?php echo (isset($activeTab) && $activeTab === 'finance') ? 'active' : ''; ?>">
                        <a href="/electromart/public/shop/finance" class="nav-link">
                            <i class="fas fa-dollar-sign"></i>
                            <span>Quản lý tài chính</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/electromart/public/home" class="nav-link">
