...
class ShopOrderController extends BaseShopController
{
    ...
    public function view($orderID)
    {
        ...
        if (!$orderDetail || !$this->shopOrderModel->checkOrderBelongsToShop($orderID, $this->shopID)) {
            ...
            header("Location: /electromart-o63e5.ondigitalocean.app/public/shop/orders");
            exit();
        }
        ...
        $this->loadShopView('order_detail', [
            ...
            'breadcrumb' => [
                ['text' => 'Dashboard', 'url' => '/electromart-o63e5.ondigitalocean.app/public/shop'],
                ['text' => 'Quản lý đơn hàng', 'url' => '/electromart-o63e5.ondigitalocean.app/public/shop/orders'],
