...
class ShopProductController extends BaseShopController
{
    ...
    public function index()
    {
        ...
        $breadcrumb = [
            ['text' => 'Trang chủ', 'url' => 'https://electromart.online/public/'],
            ['text' => 'Quản lý shop', 'url' => 'https://electromart.online/public/shop'],
            ['text' => 'Sản phẩm']
        ];
    ...
    public function add()
    {
        ...
        $breadcrumb = [
            ['text' => 'Trang chủ', 'url' => 'https://electromart.online/public/'],
            ['text' => 'Quản lý shop', 'url' => 'https://electromart.online/public/shop'],
            ['text' => 'Sản phẩm', 'url' => 'https://electromart.online/public/shop/products'],
            ['text' => 'Thêm sản phẩm']
        ];
    ...
    public function edit($productID)
    {
        ...
        if (!$product) {
            ...
            header("Location: https://electromart.online/public/shop/products");
            exit();
        }
