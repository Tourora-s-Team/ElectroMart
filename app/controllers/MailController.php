...
require_once ROOT_PATH . '/phpmailer/phpmailer/src/PHPMailer.php';
require_once ROOT_PATH  . '/phpmailer/phpmailer/src/Exception.php';
require_once ROOT_PATH  . '/phpmailer/phpmailer/src/SMTP.php';
