...
class AccountController
{
    ...
    public function updateInfo()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header("Location: https://electromart.online/public/account/info");
            exit();
        } else {
    ...
    public function addReceiver()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header("Location: https://electromart.online/public/account/receiver-info");
            exit();
        }
    ...
    public function changePassword()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header("Location: https://electromart.online/public/account/security");
            exit();
        }
    }
    ...
    public function deleteWishList($id)
    {
        ...
        header("Location: https://electromart.online/public/account/wish-list");
        exit();
    }
